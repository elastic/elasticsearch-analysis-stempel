...
```sh
bin/plugin install elasticsearch/elasticsearch-analysis-stempel/VERSION
```
...
|    es-1.7              |     2.7.0         | [2.7.0](https://github.com/elastic/elasticsearch-analysis-stempel/tree/v2.7.0/#version-270-for-elasticsearch-17)                  |
